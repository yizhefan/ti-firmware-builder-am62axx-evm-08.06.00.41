...
cat *.bin > ../../dcc_bins/dcc_viss_10b_${ISIZE}.bin
cp *.bin ../../dcc_bins/linear/
#$DCC_TOOL_PATH/dcc_bin2c ../../dcc_bins/dcc_viss_10b_${ISIZE}.bin $OUT_PATH/dcc_viss_imx219.h dcc_viss_imx219
...
$DCC_TOOL_PATH/dcc_gen_linux IMX219_viss_h3a_aewb_cfg_${ISIZE}.xml
cat *.bin > ../../dcc_bins/dcc_2a_10b_${ISIZE}.bin
cp *.bin ../../dcc_bins/linear/
#$DCC_TOOL_PATH/dcc_bin2c ../../dcc_bins/dcc_2a_10b_${ISIZE}.bin $OUT_PATH/dcc_2a_imx219.h dcc_2a_imx219
